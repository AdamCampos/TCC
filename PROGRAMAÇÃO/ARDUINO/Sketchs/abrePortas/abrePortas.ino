...
int fechaPortaEsquerda = 51;
int fechaPortaDireita = 52;
int motorSobe = 53;
int motorDesce = 54;
int motorPara = 55;
...
void loop() {
  ...
  //TESTE LOOP DE PORTA - ABRE, RECEBE SENSOR 1, FECHA, RECEBE SENSOR 2



  //  if (digitalRead(sensorPortaDireitaAberta = LOW)) {
  //    digitalWrite(led, HIGH);
  //    digitalWrite(fechaPortaDireita, HIGH);
  //    digitalWrite(abrePortaDireita, LOW);
  //  } else if (digitalRead(sensorPortaDireitaFechada = LOW)) {
  //    digitalWrite(abrePortaDireita, HIGH);
  //    digitalWrite(led, HIGH);
  //    digitalWrite(fechaPortaDireita, LOW);
  //  }
  //  else {
...
*/
  ...
  else if (digitalRead(sensorPortaDireitaAberta)) {
    digitalWrite(led, LOW);
  }
